...
{
        static ITelegramBotClient bot = new TelegramBotClient("5892972257:AAFytBMRwoRmtP3K3uJaWBmQJMn6Essb8hc");
        ...
        public static async Task HandleUpdateAsync(ITelegramBotClient botClient, Update update, CancellationToken cancellationToken)
        {
            ...
            if (message.Equals("/start"))
            {
                ...
                await botClient.SendTextMessageAsync(chatId: chatId, text: "Привет, мадмуазель! Хочешь стать еще красивее?", replyMarkup: start);
            }
